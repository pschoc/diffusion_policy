...
class DiffusionHNetHybridImagePolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
    ...
    def compute_loss(self, batch):
        ...
        noisy_trajectory = torch.cat((noisy_trajectory,noisy_trajectory), dim=2)
        ...
        loss = F.mse_loss(pred[:,:,0:2], target, reduction='none')
